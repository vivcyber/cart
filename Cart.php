...
<body>
    ...
    <div class="container" style="width: 65%">
        <h2 class="text-center m-5">Shopping Cart</h2>
        <?php
                    ...
                    <div class="col-md-3">
                        ...
                        <form method="post" action="Cart.php?action=add&id=<?php echo $row["id"]; ?>">
                            ...
                            <div class="product card bg-white">
                                   <img src="./Image/<?php echo $row["image"]; ?>" class="card-img" style="width:150px;" >
        ...
        <h3 class="title2 mt-5 text-center border-top border-primary p-5">Shopping Cart Details</h3>
